          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative w-full aspect-[4/5]">
                ...
                />
                <div className="absolute -bottom-8 -right-8 w-3/4 aspect-square z-10">
                  <Image
                  ...
                  />
                  <div className="absolute top-4 right-4 bg-primary text-white p-4 rounded-lg shadow-lg">
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
            {portfolioImages.map((image) => (
              <motion.div
                ...
                className="flex-shrink-0 w-80 h-96 relative rounded-lg overflow-hidden group"
              >
                <Image
                  src={image.url}
                  alt={image.title}
